...
export const _appRelated = ['Chrome', 'Drive', 'Dropbox', 'Evernote', 'Github'].map(
  (name, index) => {
    ...
    const shortcut =
      (name === 'Chrome' && '/app/assets/icons/app/ic_chrome.svg') ||
      (name === 'Drive' && '/app/assets/icons/app/ic_drive.svg') ||
      (name === 'Dropbox' && '/app/assets/icons/app/ic_dropbox.svg') ||
      (name === 'Evernote' && '/app/assets/icons/app/ic_evernote.svg') ||
      '/app/assets/icons/app/ic_github.svg';
